...
targetfolder=/home/jus/notebook/jus/dw/profiling/Staging
tempfile=/tmp/x.html
pushd /opt/tomcat_clover/webapps/apps/IT/Profiling/Staging
ssh $userhost -q -i $identityfile "bash /home/jus/bin/job.sh dwprof fr"
